    ...
    <div id="fh5co-page">
        ...
        <div id="fh5co-main">
            ...
            <div class="fh5co-narrow-content">
                <h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">Mostly played </h2>

                <div class="form-group">
                    <label for="upload-picture">Add folder</label>
                ...
                <h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">Recently added </h2>
                <div>
                    <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item">
                        <a href="work.html">
